        ...
        int previewW, int previewH)
{
    ALOGV("Leader before (%d, %d, %d, %d)(%d, %d, %d, %d)(%d %d)",
        node_group_info_isp->leader.input.cropRegion[0],
        node_group_info_isp->leader.input.cropRegion[1],
        node_group_info_isp->leader.input.cropRegion[2],
        node_group_info_isp->leader.input.cropRegion[3],
        node_group_info_isp->leader.output.cropRegion[0],
        node_group_info_isp->leader.output.cropRegion[1],
        node_group_info_isp->leader.output.cropRegion[2],
        node_group_info_isp->leader.output.cropRegion[3],
        node_group_info_isp->leader.request,
        node_group_info_isp->leader.vid);

    /* Leader : ISP */
    node_group_info_isp->leader.input.cropRegion[0] = bayerCropSize.x;
    node_group_info_isp->leader.input.cropRegion[1] = bayerCropSize.y;
    ...
    if (node_group_info_isp->capture[PERFRAME_BACK_SCC_POS].request) {
        ...
        node_group_info_isp->leader.output.cropRegion[0] = 0;
        node_group_info_isp->leader.output.cropRegion[1] = 0;
        node_group_info_isp->leader.output.cropRegion[2] = (bayerCropSize.w < bdsSize.w) ? bayerCropSize.w : bdsSize.w;
        node_group_info_isp->leader.output.cropRegion[3] = (bayerCropSize.h < bdsSize.h) ? bayerCropSize.h : bdsSize.h;
    }

    /* Capture 0 : SCC - [scaling] */
    node_group_info_isp->capture[PERFRAME_BACK_SCC_POS].input.cropRegion[0] = node_group_info_isp->leader.output.cropRegion[0];
    node_group_info_isp->capture[PERFRAME_BACK_SCC_POS].input.cropRegion[1] = node_group_info_isp->leader.output.cropRegion[1];
    node_group_info_isp->capture[PERFRAME_BACK_SCC_POS].input.cropRegion[2] = node_group_info_isp->leader.output.cropRegion[2];
    node_group_info_isp->capture[PERFRAME_BACK_SCC_POS].input.cropRegion[3] = node_group_info_isp->leader.output.cropRegion[3];

    node_group_info_isp->capture[PERFRAME_BACK_SCC_POS].output.cropRegion[0] = node_group_info_isp->capture[PERFRAME_BACK_SCC_POS].input.cropRegion[0];
    node_group_info_isp->capture[PERFRAME_BACK_SCC_POS].output.cropRegion[1] = node_group_info_isp->capture[PERFRAME_BACK_SCC_POS].input.cropRegion[1];
    node_group_info_isp->capture[PERFRAME_BACK_SCC_POS].output.cropRegion[2] = node_group_info_isp->capture[PERFRAME_BACK_SCC_POS].input.cropRegion[2];
    node_group_info_isp->capture[PERFRAME_BACK_SCC_POS].output.cropRegion[3] = node_group_info_isp->capture[PERFRAME_BACK_SCC_POS].input.cropRegion[3];

    /* Capture 1 : SCP - [scaling] */
    node_group_info_isp->capture[PERFRAME_BACK_SCP_POS].input.cropRegion[0] = node_group_info_isp->leader.output.cropRegion[0];
    node_group_info_isp->capture[PERFRAME_BACK_SCP_POS].input.cropRegion[1] = node_group_info_isp->leader.output.cropRegion[1];
        ...
        int previewW, int previewH)
{
    ...
    /* Capture 1 : SCP - [scaling] */
    node_group_info_isp->capture[PERFRAME_FRONT_SCP_POS].input.cropRegion[0] = node_group_info_isp->leader.output.cropRegion[0];
    node_group_info_isp->capture[PERFRAME_FRONT_SCP_POS].input.cropRegion[1] = node_group_info_isp->leader.output.cropRegion[1];
    node_group_info_isp->capture[PERFRAME_FRONT_SCP_POS].input.cropRegion[2] = node_group_info_isp->leader.output.cropRegion[2];
    node_group_info_isp->capture[PERFRAME_FRONT_SCP_POS].input.cropRegion[3] = node_group_info_isp->leader.output.cropRegion[3];
    ...
    node_group_info_isp->capture[PERFRAME_FRONT_SCP_POS].output.cropRegion[2] = previewW; // ALIGN_UP(previewW, CAMERA_ISP_ALIGN);
    node_group_info_isp->capture[PERFRAME_FRONT_SCP_POS].output.cropRegion[3] = previewH; // ALIGN_UP(previewH, CAMERA_ISP_ALIGN);
}
